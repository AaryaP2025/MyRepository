...
bool win(char **arr, const char ip)
{
    bool w = false;
    int c;
...
bool winnable(char **arr, char cip)
{
    bool w = false;
    int c, d;
    int x, y;
...
bool prevention(char **arr, char uip, char cip)
{
    bool w = false;
    int c, d;
    int x, y;
...
bool next_move(char **arr, char ip)        //Called from comp_move
{
    //cout<<"n"<<endl;
    if(*(*(arr+1)+1)=='-')
    {//cout<<"o"<<endl;
...
int comp_move(char **arr, char uip, char cip)       //Called from main
{
    //cout<<"j"<<endl;
    if(winnable(arr, cip))
    {//cout<<"k"<<endl;
